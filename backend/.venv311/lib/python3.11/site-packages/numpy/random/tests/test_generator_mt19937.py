...
class TestMultivariateHypergeometric:
    ...
    @pytest.mark.parametrize('method', ['count', 'marginals'])
    @pytest.mark.parametrize('size', [5, (2, 3), 150010])
...
class TestIntegers:
    ...
    @pytest.mark.parametrize('sample_size,high,dtype,chi2max',
        [(5001000, 5, np.int8, 125.0),          # p-value ~4.6e-25
         (5001000, 7, np.uint8, 150.0),         # p-value ~7.7e-30
         (10000000, 2500, np.int16, 3300.0),    # p-value ~3.0e-25
         (50010000, 5001, np.uint16, 6500.0),   # p-value ~3.5e-25
        ])
...
class TestRandomDist:
    ...
    def test_choice_large_sample(self):
        ...
        random = Generator(MT19937(self.seed))
        actual = random.choice(10000, 5001, replace=False)
        if sys.byteorder != 'little':
