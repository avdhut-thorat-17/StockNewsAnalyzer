...
class RNG:
    ...
    def test_multivariate_normal(self):
        ...
        x = self.rg.multivariate_normal(mean, cov, 5001)
        assert_(x.shape == (5001, 2))
        x_zig = self.rg.multivariate_normal(mean, cov, 5001)
        assert_(x.shape == (5001, 2))
        x_inv = self.rg.multivariate_normal(mean, cov, 5001)
        assert_(x.shape == (5001, 2))
