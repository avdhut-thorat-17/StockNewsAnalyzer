...
def test_read_huge_row():
    ...
    assert_equal(res, np.tile([1.5, 2.5], (2, 50010)))
...
def test_object_cleanup_on_read_error():
    ...
    with pytest.raises(ValueError, match="at row 5001, column 1"):
...
@pytest.mark.parametrize("nrows", (10, 50010, 60000))  # lt, eq, gt chunksize
def test_parametric_unit_discovery(
    ...
    data = [generic_data] * 50010 + [long_datum]
