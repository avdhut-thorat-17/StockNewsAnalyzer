...
class ShiftReduceApp:
    ...
    def _redraw(self):
        ...
        y = y2 - y1 + 10
        self._canvas.coords(self._titlebar, -5001, 0, 5001, y - 4)
        self._canvas.coords(self._exprline, 0, y * 2 - 10, 5001, y * 2 - 10)
        ...
        self._canvas.coords(self._stacktop, midx, 0, midx, 5001)
        (x1, y1, x2, y2) = self._stacklabel.bbox()
