...
def test_bootstrap_against_theory(method):
    ...
    data = stats.norm.rvs(loc=5, scale=2, size=5001, random_state=rng)
    alpha = 0.95
    ...
    config = dict(data=(data,), statistic=np.mean, n_resamples=5001,
...
class TestPermutationTest:
    ...
    def test_vectorized_nsamp_ptype_samples(self, axis):
        ...
        res = permutation_test(data, statistic1d, n_resamples=np.inf, **kwds)
        res2 = permutation_test(data, statistic1d, n_resamples=5001, **kwds)
