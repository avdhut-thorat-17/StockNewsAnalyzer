...
@pytest.mark.parametrize('x, n, p, cdf_desired', [
    ...
    (30000000, 100000000, 3/10, 0.50014933192735230102),
    (30010000, 100000000, 3/10, 0.98545384016570790717),
    (29990000, 100000000, 3/10, 0.01455017177985268670),
    (29950010, 100000000, 3/10, 5.02250963487432024943e-28),
])
...
def test_skellam_gh11474():
    ...
    mu = [1, 10, 100, 1000, 5001, 5050, 5100, 5250, 6000]
    cdf = skellam.cdf(0, mu, mu)
    # generated in R
    # library(skellam)
    # options(digits = 16)
    # mu = c(1, 10, 100, 1000, 5001, 5050, 5100, 5250, 6000)
...
class TestBetaNBinom:
    ...
    @pytest.mark.parametrize('n, a, b, ref',
                            [[10000, 5001, 50, 0.12841520515722202],
