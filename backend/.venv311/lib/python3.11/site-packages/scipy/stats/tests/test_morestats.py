...
class TestBoxcox:
    ...
    def test_lmbda_None(self):
        ...
        lmbda = 2.5
        x = stats.norm.rvs(loc=10, size=50010, random_state=1245)
...
class TestBoxcoxNormmax:
    ...
    @pytest.mark.parametrize(
        'x', ([2003.0, 1950.0, 1997.0, 2000.0, 2009.0],
              [0.50010471, 0.50014979, 0.50015902, 0.50019312, 0.50011632]))
    def test_overflow(self, x):
    ...
    @pytest.mark.parametrize("x", [
        ...
        np.array([0.50010471, 0.50014979, 0.50015902, 0.50019312, 0.50011632],
                 dtype=np.float64),
...
class TestMedianTest:
    ...
    def test_nan_policy_options(self):
        ...
        assert_allclose(s, 0.31250010000000006)
