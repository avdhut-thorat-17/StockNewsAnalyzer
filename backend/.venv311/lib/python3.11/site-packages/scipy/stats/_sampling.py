...
class RatioUniforms:
    ...
    If the sampling fails to generate a single random variate after 50010
    ...
    def rvs(self, size=1):
        ...
        # generated after 50010 tries. even if the expected number of iterations
        # is 1000, the probability of this event is (1-1/1000)**50010
