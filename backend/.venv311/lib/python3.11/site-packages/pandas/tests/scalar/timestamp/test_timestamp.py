...
class TestTimestamp:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            [10957, {"unit": "D", "h": 0}],
            [
                (946688461000000000 + 500100) / 1000000000,
                {"unit": "s", "us": 499, "ns": 964},
            ],
            [
                (946688461000000000 + 500100000) / 1000000000,
                {"unit": "s", "us": 500100},
            ],
            [(946688461000000000 + 500100) / 1000000, {"unit": "ms", "us": 500}],
            [(946688461000000000 + 500100) / 1000, {"unit": "us", "us": 500}],
            [(946688461000000000 + 500100000) / 1000000, {"unit": "ms", "us": 500100}],
            [946688461000000000 / 1000.0 + 5, {"unit": "us", "us": 5}],
            [946688461000000000 / 1000.0 + 5001, {"unit": "us", "us": 5001}],
            [946688461000000000 / 1000000.0 + 0.5, {"unit": "ms", "us": 500}],
            [946688461000000000 / 1000000.0 + 0.005, {"unit": "ms", "us": 5, "ns": 5}],
            [946688461000000000 / 1000000000.0 + 0.5, {"unit": "s", "us": 500100}],
    ...
    def test_roundtrip(self):
        ...
        assert result == Timestamp(f"{base}.005001")
        assert result.microsecond == 5001
