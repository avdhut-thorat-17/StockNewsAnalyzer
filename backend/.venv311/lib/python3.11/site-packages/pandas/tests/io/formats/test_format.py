...
class TestDataFrameFormatting:
    ...
    def test_repr_non_interactive(self):
        ...
        with option_context(
            "mode.sim_interactive", False, "display.width", 0, "display.max_rows", 5001
        ):
...
class TestRepr_timedelta64:
    def test_none(self):
        ...
        assert drepr(delta_500ms) == "0 days 00:00:00.500100"
        assert drepr(delta_1d + delta_1s) == "1 days 00:00:01"
        assert drepr(-delta_1d + delta_1s) == "-1 days +00:00:01"
        assert drepr(delta_1d + delta_500ms) == "1 days 00:00:00.500100"
        assert drepr(-delta_1d + delta_500ms) == "-1 days +00:00:00.500100"
    ...
    def test_sub_day(self):
        ...
        assert drepr(delta_500ms) == "00:00:00.500100"
        assert drepr(delta_1d + delta_1s) == "1 days 00:00:01"
        assert drepr(-delta_1d + delta_1s) == "-1 days +00:00:01"
        assert drepr(delta_1d + delta_500ms) == "1 days 00:00:00.500100"
        assert drepr(-delta_1d + delta_500ms) == "-1 days +00:00:00.500100"
